            ...
            <div className="flex items-center space-x-3">
              <label className="flex items-center space-x-2 text-sm text-slate-300">
                <input
                  ...
                  className="rounded-sm bg-slate-700 border-slate-600"
                />
              ...
              {healthReport.aiSuggestions.map((suggestion, idx) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    {suggestion.action && (
                      <button className="ml-4 px-3 py-1 bg-white/10 hover:bg-white/20 rounded-sm text-sm transition-colors">
                        Take Action
                      </button>
                    )}
                  </div>
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {device.quickActions.map((action, idx) => (
                            <button
                              ...
                              className="px-3 py-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-white text-xs rounded-sm transition-colors"
                            >
                              {action.label}
                            </button>
                          ))}
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {device.quickActions.map((action, idx) => (
                            <button
                              ...
                              onClick={() => executeQuickAction(action.action, action.params)}
                              disabled={executing === action.action}
                              className="px-3 py-1 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 text-white text-xs rounded-sm transition-colors"
                            >
                              {action.label}
                            </button>
                          ))}
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {device.quickActions.map((action, idx) => (
                            <button
                              ...
                              onClick={() => executeQuickAction(action.action, action.params)}
                              disabled={executing === action.action}
                              className="px-3 py-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-600 text-white text-xs rounded-sm transition-colors"
                            >
                              {action.label}
                            </button>
                          ))}
                        ...
                        <div className="flex gap-2 flex-wrap">
                          {device.quickActions.map((action, idx) => (
                            <button
                              ...
                              onClick={() => executeQuickAction(action.action, action.params)}
                              disabled={executing === action.action}
                              className="px-3 py-1 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-600 text-white text-xs rounded-sm transition-colors"
                            >
                              {action.label}
                            </button>
                          ))}
