        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Link
                href="/ai-hub"
                className="p-4 bg-linear-to-br from-purple-600/40 to-blue-600/40 rounded-lg border-2 border-purple-400/50 hover:border-purple-400/70 transition-all"
              >
              ...
              <Link
                href="/system-admin"
                className="p-4 bg-linear-to-br from-blue-600/40 to-indigo-600/40 rounded-lg border-2 border-blue-400/50 hover:border-blue-400/70 transition-all"
              >
              ...
              <Link
                href="/device-config"
                className="p-4 bg-linear-to-br from-green-600/40 to-teal-600/40 rounded-lg border-2 border-green-400/50 hover:border-green-400/70 transition-all"
              >
