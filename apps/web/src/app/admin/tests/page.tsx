...
export default function AdminTestsPage() {
  ...
  if (loading) {
    return (
      <SportsBarLayout>
        <div className="min-h-screen bg-linear-to-br from-sportsBar-900 via-sportsBar-800 to-sportsBar-900 flex items-center justify-center">
  ...
  return (
    <SportsBarLayout>
      <div className="min-h-screen bg-linear-to-br from-sportsBar-900 via-sportsBar-800 to-sportsBar-900">
        <SportsBarHeader
              ...
              <div className="card p-6">
                ...
                <div className="mb-6">
                  <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 rounded-sm border-slate-600 text-emerald-500 focus:ring-2 focus:ring-emerald-500"
                      disabled={running}
                    />
                ...
                <div className="mb-6">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 text-white focus:outline-hidden focus:ring-2 focus:ring-emerald-500"
                    disabled={running}
                  >
                    {suites.map(suite => (
