...
export default function LayoutEditorPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-blue-900 to-slate-800 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            {/* Upload Section */}
            <div className="bg-slate-800/50 backdrop-blur-xs rounded-lg p-4 border border-slate-700/50">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-sm text-white mb-3"
              ...
              <label htmlFor="file-upload">
                <div className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-sm cursor-pointer text-center transition-all">
            ...
            <div className="bg-slate-800/50 backdrop-blur-xs rounded-lg p-4 border border-slate-700/50">
              ...
              {(layout as any).professionalImageUrl && (
                <div className="mt-3 p-2 bg-green-900/30 border border-green-700/50 rounded-sm text-xs text-green-300">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          ...
                          {zone.ocrMethod === 'ollama' && (
                            <span className="px-1.5 py-0.5 bg-blue-500/20 border border-blue-400/30 rounded-sm text-[10px] font-semibold text-blue-300 flex items-center">
                              <Sparkles className="w-2.5 h-2.5 mr-0.5" />
                              AI
                            </span>
                          )}
                          {zone.ocrMethod === 'tesseract' && (
                            <span className="px-1.5 py-0.5 bg-green-500/20 border border-green-400/30 rounded-sm text-[10px] font-semibold text-green-300 flex items-center">
                    ...
                    {selectedZone === zone.id && (
                      <div className="space-y-2 text-sm">
                        <input
                          ...
                          className="w-full px-2 py-1 bg-slate-800 border border-slate-600 rounded-sm text-white text-sm"
                          placeholder="Label"
                        />
