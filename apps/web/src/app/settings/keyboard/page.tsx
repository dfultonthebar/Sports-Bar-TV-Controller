      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div className="bg-linear-to-br from-blue-500 to-purple-500 rounded-xl p-3 shadow-lg">
          ...
          <div className="backdrop-blur-xl bg-blue-500/10 border border-blue-400/30 rounded-xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-slate-300">
                ...
                <p>
                  Press <kbd className="px-2 py-1 bg-slate-800 rounded-sm border border-slate-700 font-mono text-xs">?</kbd> anywhere
          ...
          <section className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {navigationShortcuts.map((shortcut) => (
                <div
                  key={shortcut.keys}
                  className="group p-4 bg-linear-to-br from-slate-800/50 to-slate-900/50 border border-slate-700 rounded-lg hover:border-blue-400/50 hover:from-blue-900/20 hover:to-purple-900/20 transition-all duration-200"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-slate-200 font-medium">{shortcut.description}</span>
                    <kbd className="px-3 py-1.5 bg-slate-700 group-hover:bg-slate-600 rounded-sm border border-slate-600 group-hover:border-blue-500 font-mono text-sm text-slate-200 transition-colors">
                      {shortcut.keys}
                    </kbd>
                  </div>
                </div>
          ...
          <section className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {generalShortcuts.map((shortcut) => (
                <div
                  key={shortcut.keys}
                  className="group p-4 bg-linear-to-br from-slate-800/50 to-slate-900/50 border border-slate-700 rounded-lg hover:border-purple-400/50 hover:from-purple-900/20 hover:to-pink-900/20 transition-all duration-200"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-slate-200 font-medium">{shortcut.description}</span>
                    <kbd className="px-3 py-1.5 bg-slate-700 group-hover:bg-slate-600 rounded-sm border border-slate-600 group-hover:border-purple-500 font-mono text-sm text-slate-200 transition-colors">
                      {shortcut.keys}
                    </kbd>
                  </div>
                </div>
          ...
          <section className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl">
            ...
            <div className="space-y-3 text-slate-300">
              <div className="flex items-start gap-3">
                ...
                <span>Use <kbd className="px-2 py-1 bg-slate-800 rounded-sm border border-slate-700 font-mono text-xs">Ctrl</kbd> key</span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-purple-400 font-bold">macOS:</span>
                <span>Use <kbd className="px-2 py-1 bg-slate-800 rounded-sm border border-slate-700 font-mono text-xs">Cmd</kbd> key (⌘)</span>
              </div>
              <div className="flex items-start gap-3">
