...
export default function DraggableZone({
  ...
  const resizeHandleClass = "absolute w-4 h-4 bg-blue-500 border-2 border-white rounded-xs shadow-md z-10 hover:bg-blue-600 transition-colors"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Label */}
        <div
          className="mt-1 px-2 py-0.5 rounded-sm text-xs font-semibold truncate max-w-full text-white"
