...
export default function LayoutZoomControls({
  ...
  return (
    <div className="absolute bottom-4 right-4 flex items-center gap-2 bg-slate-800/95 backdrop-blur-xs rounded-xl p-2 shadow-xl border border-slate-700 z-20">
      {/* Pan Mode Toggle */}
      <button
        onClick={onPanToggle}
