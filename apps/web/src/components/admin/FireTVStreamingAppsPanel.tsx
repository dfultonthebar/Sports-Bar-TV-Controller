      ...
      <div className="flex items-center justify-between mb-1">
        ...
        {selectedDeviceId && (
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-2 px-3 py-1.5 text-sm rounded-sm border border-slate-600 text-slate-300 hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                      {apps.map(app => (
                        <div
                          ...
                          className="rounded-sm border border-slate-700 bg-slate-800/50 p-3"
                        >
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <span className="text-[10px] px-2 py-0.5 rounded-sm bg-green-500/20 text-green-400 border border-green-500/30 shrink-0">
                              installed
                            </span>
                          </div>
                        </div>
