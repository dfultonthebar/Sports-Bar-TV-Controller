...
export default function ChannelPresetsPanel() {
  ...
  const handleReorder = async (id: string, direction: 'up' | 'down') => {
    ...
    try {
      ...
      logger.error('Error reordering presets:', err)
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-2 text-white placeholder-gray-500 focus:outline-hidden focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50"
                    autoComplete="off"
                    autoFocus
                  />
                </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          ...
                          value={formData.name}
                          onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                          className="w-full bg-gray-900 border border-gray-700 rounded-lg px-3 py-2 text-white focus:outline-hidden focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50"
                          autoComplete="off"
                          autoFocus
                        />
                      </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex flex-col gap-1">
                        <button
                          ...
                          disabled={index === 0}
                          className="p-1 hover:bg-gray-700 rounded-sm disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                        >
