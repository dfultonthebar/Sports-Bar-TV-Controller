      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 py-4">
          {shortcuts.map((shortcut) => (
            ...
            >
              ...
              <kbd className="px-2 py-1 text-xs font-semibold text-slate-200 bg-slate-700 rounded-sm border border-slate-600 font-mono">
                {shortcut.keys}
              </kbd>
            </div>
          ))}
        ...
        <div className="mt-2 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
          <p className="text-sm text-slate-400">
            ...
            <kbd className="px-1.5 py-0.5 text-xs bg-slate-700 rounded-sm border border-slate-600 font-mono">
              ?
            </kbd>{' '}
