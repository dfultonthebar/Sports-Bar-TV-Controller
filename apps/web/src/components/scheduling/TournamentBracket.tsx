...
export default function TournamentBracket({
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2">
          {tournaments.map((t, index) => (
            <Button
              ...
              variant={selectedTournament === index ? 'default' : 'outline-solid'}
              className="shrink-0"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {bracket.roundName && (
            <div className="bg-slate-900/50 p-4 rounded-lg">
              ...
              <div className="text-2xl font-bold text-white">{bracket.roundName}</div>
          ...
          {bracket.totalTeams && (
            <div className="bg-slate-900/50 p-4 rounded-lg">
              ...
              <div className="text-2xl font-bold text-white">{bracket.totalTeams}</div>
      ...
      {/* Games by Round */}
      <div className="rounded-lg border border-slate-700 bg-slate-900/40 p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Tournament Games</h3>
        <p className="text-sm text-slate-400 mb-4">All games organized by playoff round</p>
              ...
              .map(([round, roundGames]) => (
                <div key={round}>
                  <h3 className="text-lg font-semibold text-slate-200 mb-3 flex items-center gap-2">
                    <div className="w-1 h-6 bg-slate-500 rounded-sm" />
                    {round || 'Round TBD'}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {roundGames
                      ...
                      .map((game) => (
                        <div
                          key={game.id}
                          className={`bg-slate-900/40 p-4 rounded-lg border transition-all ${
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            {/* Away Team */}
                            <div className="flex items-center justify-between p-2 rounded-sm bg-slate-800/40">
                              <div className="flex items-center gap-2">
