  ...
  const loadMatrixInputs = async () => {
    try {
      ...
      if (data.inputs && Array.isArray(data.inputs)) {
        ...
        logger.info('Loaded Wolfpack inputs:', inputs)
      } else {
        logger.info('No Wolfpack inputs found in database')
        setMatrixInputs([])
      }
    } catch (error) {
      logger.error('Error loading Wolfpack matrix inputs:', error)
      setMatrixInputs([])
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-linear-to-br from-blue-400/20 to-cyan-400/20 rounded-lg backdrop-blur-xs border border-blue-500/30">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-blue-500/30 border border-blue-400 text-white rounded-lg hover:bg-blue-500/40 transition-all backdrop-blur-xs"
        >
      ...
      {/* Add Device Form */}
      {showAddDevice && (
        <div className="bg-slate-800/50 backdrop-blur-xs p-6 rounded-lg border border-blue-500/30">
          ...
          <div className="mt-4 flex space-x-3">
            <button
              ...
              className="px-4 py-2 bg-blue-500/30 border border-blue-400 text-white rounded-lg hover:bg-blue-500/40 disabled:opacity-50 transition-all backdrop-blur-xs"
            >
          ...
          <div className="bg-slate-800/50 backdrop-blur-xs p-6 rounded-lg border border-blue-500/30">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="px-3 py-1 text-sm bg-blue-500/30 border border-blue-400 text-white rounded-sm hover:bg-blue-500/40 transition-all"
              >
      ...
      {/* No Devices Message */}
      {devices.length === 0 && (
        <div className="text-center py-12 bg-slate-800/50 backdrop-blur-xs rounded-lg border border-blue-500/30">
          ...
          <button
            ...
            className="px-6 py-3 bg-blue-500/30 border border-blue-400 text-white rounded-lg hover:bg-blue-500/40 transition-all backdrop-blur-xs"
          >
            Add Fire TV Device
          </button>
        </div>
