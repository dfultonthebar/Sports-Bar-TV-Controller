      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="rounded-lg border border-slate-700 bg-slate-800 p-4">
          ...
          <select
            ...
            className="w-full h-12 rounded-lg bg-slate-900 border border-slate-600 text-white text-sm px-3 focus:outline-hidden focus:ring-2 focus:ring-green-500"
          >
        ...
        <div className="rounded-lg border border-slate-700 bg-slate-800 p-4">
          ...
          <select
            ...
            className="w-full h-12 rounded-lg bg-slate-900 border border-slate-600 text-white text-sm px-3 focus:outline-hidden focus:ring-2 focus:ring-blue-500"
          >
            ...
            {zones
              ...
              .map((zone) => (
                <div key={zone.id} className="flex items-center gap-3">
                  <span className="text-sm text-slate-400 w-28 truncate shrink-0">{zone.name}</span>
