    ...
    <div className={`rounded-xl border transition-colors ${
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-1">
        <div className="flex items-center gap-2 min-w-0">
          <Users className={`w-4 h-4 shrink-0 ${group.muted ? 'text-slate-500' : 'text-purple-400'}`} />
      ...
      <div className="px-4 pb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center w-11 h-11 rounded-xl bg-slate-700/60 border border-slate-600/50 text-slate-300 text-lg font-bold active:scale-95 active:bg-slate-600 transition-all disabled:opacity-30 disabled:active:scale-100 shrink-0"
          >
            −
          </button>
