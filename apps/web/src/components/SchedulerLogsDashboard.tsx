...
const OPERATIONS = [
  ...
  { value: 'under-served', label: 'Under-served' },
...
const OPERATION_COLORS: Record<string, string> = {
  ...
  'assign': 'bg-green-500/20 text-green-400 border-green-500/30',
  'drop': 'bg-red-500/20 text-red-400 border-red-500/30',
  'under-served': 'bg-amber-500/20 text-amber-400 border-amber-500/30',
          ...
          <div className="space-y-3">
            {metrics.recentErrors.map((error) => (
              ...
              >
                ...
                {error.errorMessage && (
                  <p className="text-sm text-red-400 font-mono bg-red-950/30 p-2 rounded-sm mt-2">
                    {error.errorMessage}
                  </p>
                )}
