    ...
    <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-800/50 border border-slate-700 rounded-md px-3 py-2 text-slate-100 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-800/50 border border-slate-700 rounded-md px-3 py-2 text-slate-100 focus:outline-hidden focus:ring-2 focus:ring-blue-500"
                required
              >
            ...
            <div className="flex space-x-3">
              <button
                type="submit"
                className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-hidden focus:ring-2 focus:ring-blue-500"
              >
              ...
              <button
                type="button"
                onClick={resetForm}
                className="bg-gray-300 text-slate-200 px-4 py-2 rounded-md hover:bg-gray-400 focus:outline-hidden focus:ring-2 focus:ring-gray-500"
              >
                Cancel
              </button>
            </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          <li>• <strong>Ollama (Local) - RECOMMENDED:</strong> Install Ollama locally and pull a model (e.g., <code className="bg-blue-100 px-1 rounded-sm">ollama pull llama3.2</code>) - No API key required</li>
