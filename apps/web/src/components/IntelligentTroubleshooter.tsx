                  ...
                  <div className="space-y-4">
                    {diagnostic.issues.map((issue) => (
                      <div key={issue.id} className="border rounded-lg p-4">
                        ...
                        <div className="bg-slate-800 or bg-slate-900 p-3 rounded-sm">
                    ...
                    {diagnostic.recommendedActions.map((action) => (
                      <div key={action.id} className="border rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                          <div className="bg-slate-800 or bg-slate-900 p-2 rounded-sm text-sm">
                            <span className="font-medium">Time:</span> {action.estimatedTime}
                          </div>
                          <div className="bg-green-50 p-2 rounded-sm text-sm">
                            <span className="font-medium">Success Rate:</span> {action.successProbability}%
                          </div>
                        </div>

                        <div className="bg-blue-50 p-3 rounded-sm mb-3">
