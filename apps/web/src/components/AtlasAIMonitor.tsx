      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-linear-to-r from-blue-900/20 to-blue-900/20 p-4 rounded-lg border border-blue-800/40">
              <div className="flex items-center space-x-2 mb-2">
            ...
            <div className="bg-linear-to-r from-teal-50 to-emerald-50 p-4 rounded-lg border border-teal-200">
              <div className="flex items-center space-x-2 mb-2">
              ...
              <div className="space-y-1">
                {analysis.hardwareRecommendations.map((rec: string, index: number) => (
                  <div key={index} className="text-sm text-orange-600 flex items-start space-x-2">
                    <Settings className="w-3 h-3 text-orange-500 mt-0.5 shrink-0" />
                    <span>{rec}</span>
                  </div>
                ))}
              </div>
          ...
          <CardContent>
            <div className="space-y-2">
              {analysis.audioPatterns.map((pattern: string, index: number) => (
                <div key={index} className="bg-blue-900/20 border border-blue-800/40 rounded-sm p-3">
