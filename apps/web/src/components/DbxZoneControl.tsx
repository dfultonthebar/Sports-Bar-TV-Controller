...
export default function DbxZoneControl({ processorId, compact = false }: DbxZoneControlProps) {
  ...
  return (
    <div className={compact ? 'space-y-3' : 'space-y-4'}>
      {/* Info banner */}
      <div className="bg-linear-to-r from-orange-900/30 to-amber-900/30 border border-orange-500/30 rounded-lg p-3">
          ...
          >
            ...
            <div className="mb-3">
              ...
              <select
                ...
                className="w-full bg-slate-900 border border-slate-700 rounded-sm px-2 py-1.5 text-sm text-slate-200 focus:outline-hidden focus:border-orange-500"
              >
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="shrink-0 w-12 h-12 rounded-lg bg-slate-700 hover:bg-slate-600 active:bg-slate-500 disabled:opacity-30 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
                >
