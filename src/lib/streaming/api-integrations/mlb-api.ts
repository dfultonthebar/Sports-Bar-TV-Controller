...
export class MLBApiClient {
  ...
  constructor(config: MLBApiConfig = {}) {
    ...
    console.log('[MLB API] Client initialized')
  }
  ...
  public async getSchedule(options?: {
    ...
    try {
      console.log('[MLB API] Getting schedule')
      ...
      console.error('[MLB API] Error getting schedule:', error)
      throw error
    }
  }
  ...
  public async getGame(gamePk: number): Promise<any> {
    try {
      console.log(`[MLB API] Getting game ${gamePk}`)
      ...
      console.error('[MLB API] Error getting game:', error)
      throw error
    }
  }
  ...
  public async getTeams(): Promise<MLBTeam[]> {
    try {
      console.log('[MLB API] Getting all teams')
      ...
      console.error('[MLB API] Error getting teams:', error)
      throw error
    }
  }
  ...
  public async getTeam(teamId: number): Promise<MLBTeam> {
    try {
      console.log(`[MLB API] Getting team ${teamId}`)
      ...
      console.error('[MLB API] Error getting team:', error)
      throw error
    }
  }
