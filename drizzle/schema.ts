...
export const homeTeam = sqliteTable("HomeTeam", {
	...
	location: text(),
	conference: text(),
	isPrimary: integer().default(false).notNull(),
	logoUrl: text(),
	primaryColor: text(),
	secondaryColor: text(),
...
export const matrixConfig = sqliteTable("MatrixConfig", {
	...
	description: text(),
	config: text().notNull(),
	isActive: integer().default(false).notNull(),
	createdAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
	updatedAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
});
...
export const matrixInput = sqliteTable("MatrixInput", {
	...
	isActive: integer().default(true).notNull(),
	status: text().default("active").notNull(),
	powerOn: integer().default(false).notNull(),
	isCecPort: integer().default(false).notNull(),
	createdAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
	updatedAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
},
(table) => [
...
export const matrixOutput = sqliteTable("MatrixOutput", {
	...
	dailyTurnOn: integer().default(false).notNull(),
	dailyTurnOff: integer().default(false).notNull(),
	tvBrand: text(),
	tvModel: text(),
	cecAddress: text(),
	lastDiscovery: text(),
...
export const schedule = sqliteTable("Schedule", {
	...
	endTime: text(),
	recurring: integer().default(false).notNull(),
	daysOfWeek: text(),
	enabled: integer().default(true).notNull(),
	createdAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
	updatedAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
...
export const aiGainConfiguration = sqliteTable("AIGainConfiguration", {
	...
	enabled: integer().default(false).notNull(),
	lastAdjustment: text(),
...
export const atlasConnectionState = sqliteTable("AtlasConnectionState", {
	id: text().primaryKey().notNull(),
	processorId: text().notNull().references(() => audioProcessor.id, { onDelete: "cascade" } ),
	isConnected: integer().default(false).notNull(),
	lastConnected: text(),
...
export const atlasMeterReading = sqliteTable("AtlasMeterReading", {
	...
	level: real().notNull(),
	peak: real(),
	clipping: integer().default(false).notNull(),
	timestamp: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
},
(table) => [
...
export const atlasParameter = sqliteTable("AtlasParameter", {
	...
	readOnly: integer().default(false).notNull(),
	isSubscribed: integer().default(false).notNull(),
	lastUpdated: text(),
	createdAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
	updatedAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
},
...
export const audioZone = sqliteTable("AudioZone", {
	...
	muted: integer().default(false).notNull(),
	enabled: integer().default(true).notNull(),
	createdAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
	updatedAt: text().default("sql`(CURRENT_TIMESTAMP)`").notNull(),
},
...
export const cecConfiguration = sqliteTable("CECConfiguration", {
	id: text().primaryKey().notNull(),
	isEnabled: integer().default(false).notNull(),
	cecInputChannel: integer(),
...
export const fireCubeApp = sqliteTable("FireCubeApp", {
	...
	category: text(),
	iconUrl: text(),
	isSystemApp: integer().default(false).notNull(),
	isSportsApp: integer().default(false).notNull(),
	hasSubscription: integer().default(false).notNull(),
...
export const fireCubeDevice = sqliteTable("FireCubeDevice", {
	...
	adbEnabled: integer().default(false).notNull(),
	status: text().default("discovered").notNull(),
	lastSeen: text(),
	keepAwakeEnabled: integer().default(false).notNull(),
...
export const fireCubeSportsContent = sqliteTable("FireCubeSportsContent", {
	...
	endTime: text(),
	channel: text(),
	isLive: integer().default(false).notNull(),
	deepLink: text(),
	thumbnailUrl: text(),
	description: text(),
