/**
 * Game Priority Updater Service
 *
 * Bulk priority calculation and database updates for game schedules.
 ...
 * - Game timing
 *
 * This service directly updates the gameSchedules table with calculated priorities.
 * For real-time priority scoring without DB updates, use PriorityCalculator instead.
 */
...
export class GamePriorityUpdater {
...
// Singleton instance
let updaterInstance: GamePriorityUpdater | null = null

/**
 * Get singleton instance of GamePriorityUpdater
 */
export function getGamePriorityUpdater(): GamePriorityUpdater {
  if (!updaterInstance) {
    updaterInstance = new GamePriorityUpdater()
  }
 ...
 */
export function resetGamePriorityUpdater(): void {
 ...
 */
export const gamePriorityUpdater = getGamePriorityUpdater()
