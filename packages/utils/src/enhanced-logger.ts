 ...
 * Provides verbose logging with file output for debugging and monitoring
 */
...
export class Logger {
  ...
  constructor(context: string, logDir?: string) {
...
export function createLogger(context: string, logDir?: string): Logger {
  return new Logger(context, logDir)
}
