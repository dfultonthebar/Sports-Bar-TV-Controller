...
const SCREENSHOTS_DIR = '/tmp/ui-screenshots/before';
...
async function captureAllPages() {
  console.log('🎨 Starting comprehensive UI capture...\n');
