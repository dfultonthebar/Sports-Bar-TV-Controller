# Schedule Games Ahead of Time — Bartender Help

**For:** the bartender prepping for a busy game day (NFL Sunday, big basketball night, anything with 4+ games at once).
**Goal:** assign TVs to games BEFORE kickoff so you're not running around when the bar fills up.
**Time to set up:** 2-3 minutes for an afternoon's worth of games.
**You can't break it:** every entry can be edited or canceled. The worst that happens is one TV shows the wrong game for a few seconds when it auto-tunes — you fix that by editing the entry. Try things.

---

## When you'd use this

The manager says "we have 8 games on Sunday, set them up now." Or you walk in at 4pm, see the early NFL games are wrapping up, and you want the late games queued up on the right TVs before the 4:25pm kickoffs. This is the proactive flow — much faster than scrambling when customers start asking.

If a customer is at the bar right now asking for a game that's already playing, this isn't the page you want. Go to **[[FINDING_A_LIVE_GAME]]** or **[[PUTTING_GAMES_ON_TVS_VIDEO_TAB]]**.
...
## Canceling or changing an assignment
...
- **[[FINDING_A_LIVE_GAME]]** — game is already playing, customer is asking right now.
- **[[PUTTING_GAMES_ON_TVS_VIDEO_TAB]]** — switching a TV directly, no schedule.
- **[[OVERRIDE_LEARN]]** — when the system suggests making a regular manual change permanent.
- **[[SHIFT_BRIEF_AT_CLOCK_IN]]** — the heads-up summary that tells you what's on tonight.
