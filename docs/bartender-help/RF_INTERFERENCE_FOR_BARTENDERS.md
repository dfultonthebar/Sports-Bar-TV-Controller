...
|---|---|---|---|
| **Yellow** | Priority Override Active — somebody is on a mic / page / intercom right now | Atlas audio processor detects a priority input above −45 dB | Nothing. Music ducks automatically, comes back when the mic stops. |
| **Cyan** | RF Interference Detected on Wireless Mic | Shure wireless-mic receiver sees a foreign radio signal on our mic frequency | Watch the wireless mic; if it acts up, follow "When the wireless mic cuts out" below. |
...
### Yellow banner — "Priority Override Active" (mic, page, or intercom is on)
...
### Cyan banner — "RF Interference Detected on Wireless Mic" (radio waves from outside the bar)
