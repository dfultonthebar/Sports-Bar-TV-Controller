...
**Node version status (per Standing Rule 10):** ✅ 6/6 on Node 22 (2026-05-26). nvm-based: holmgren (22.22.0), leglamp (22.22.3). apt/NodeSource-based: luckys/graystone/appleton/greenville (22.22.2 — held back one patch by NodeSource's slower per-major release cadence; Node.js released 22.22.3 on 2026-05-13 but NodeSource hadn't published the .deb as of 2026-05-26). Will pick up on next NodeSource publish + auto-update cycle.
