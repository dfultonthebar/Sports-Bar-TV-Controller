  ...
  apps: [
    {
      ...
      env: {
        ...
        // SDR watcher gate. Set in .env via scripts/setup-sdr.sh as 'auto'
        // (start only when dongle detected) or 'true' (force-start, error
        // every 5min if no dongle). Default unset = disabled.
